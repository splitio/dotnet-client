...
namespace Splitio.Services.Client.Classes
{
    public class SelfRefreshingClient : SplitClient
    {
        ...
        private void BuildTelemetryStorage()
        {
            ...
            _telemetryEvaluationProducer = new TelemetryEvaluationProducer(telemetryStorage);
            _telemetryInitProducer = new TelemetryInitProducer(telemetryStorage);
            _telemetryRuntimeProducer = new TelemetryRuntimeProducer(telemetryStorage);

            _telemetryEvaluationConsumer = new TelemetryEvaluationConsumer(telemetryStorage);
            _telemetryInitConsumer = new TelemetryInitConsumer(telemetryStorage);
            _telemetryRuntimeConsumer = new TelemetryRuntimeConsumer(telemetryStorage);
        }
        ...
        private void BuildTelemetrySyncTask()
        {
            ...
            _telemetrySyncTask = new TelemetrySyncTask(_telemetryInitConsumer, _telemetryRuntimeConsumer, _telemetryEvaluationConsumer, telemetryAPI, _splitCache, _segmentCache, _gates, _config, FactoryInstantiationsService.Instance());
        }
