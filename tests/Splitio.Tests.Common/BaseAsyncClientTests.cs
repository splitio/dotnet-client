...
namespace Splitio.Tests.Common
{
    ...
    public abstract class BaseAsyncClientTests
    {
        ...
        [TestMethod]
        public async Task FallbackTreatments_WhenFeatureDoesNotExist()
        {
            ...
            // Act.
            var result = await client.GetTreatmentsWithConfigAsync("nico_test", features);
            await client.DestroyAsync();
            ...
            var impExp = Helper.GetImpressionExpected("feature2", "nico_test");
            ...
            impExp = Helper.GetImpressionExpected("feature", "nico_test");
        ...
        [TestMethod]
        public async Task FallbackTreatments_WhenExceptionOccurrs()
        {
            ...
            var impExp = Helper.GetImpressionExpected("feature3", "nico_test");
            KeyImpression impExpected1 = new KeyImpression(impExp.keyName, impExp.feature, impExp.treatment, impExp.time, impExp.changeNumber, impExp.label, impExp.bucketingKey, impExp.ImpressionsDisabled, impExp.previousTime, impExp.optimized);
