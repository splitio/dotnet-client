...
namespace Splitio_Tests.Unit_Tests
{
    ...
    public class GreaterOrEqualToMatcherTests
    {
        ...
        {
            //Arrange
            var matcher = new GreaterOrEqualToMatcher(new UnaryNumericData { dataType = DataTypeEnum.NUMBER, value = 1000001 });
        ...
        {
            //Arrange
            var matcher = new GreaterOrEqualToMatcher(new UnaryNumericData { dataType = DataTypeEnum.DATETIME, value = 1470960000000 });
        ...
        public void MatchDateTruncateToMinutesSuccesfully()
        {
            ...
            var matcher = new GreaterOrEqualToMatcher(new UnaryNumericData { dataType = DataTypeEnum.DATETIME, value = 1482207323000 });
        ...
        {
            //Arrange
            var matcher = new GreaterOrEqualToMatcher(new UnaryNumericData { dataType = DataTypeEnum.STRING, value = 1470960000000 });
