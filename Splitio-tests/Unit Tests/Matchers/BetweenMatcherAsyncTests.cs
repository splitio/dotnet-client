...
{
    [TestClass]
    public class BetweenMatcherAsyncTests
    {
        [TestMethod]
        public async Task MatchAsyncNumberSuccesfully()
        {
            ...
            var result3 = await matcher.MatchAsync(98981700000);
        ...
        public async Task MatchAsyncDateSuccesfully()
        {
            ...
            var result2 = await matcher.MatchAsync("1490910000000".ToDateTime().Value);
